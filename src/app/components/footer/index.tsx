      ...
      <Container>
        <Stack direction={"row"} sx={{ mt: "94px" }}>
          <Stack direction={"column"} style={{ width: "340px" }}>
            <Box>
              <img width={"100px"} src={"/icons/burak.svg"} alt="No img?" />
            </Box>
            ...
            <Box className="sns-context">
              <img src={"/icons/facebook.svg"} alt="No img?" />
              <img src={"/icons/twitter.svg"} alt="No img?" />
              <img src={"/icons/instagram.svg"} alt="No img?" />
              <img src={"/icons/youtube.svg"} alt="No img?" />
            </Box>
          </Stack>
